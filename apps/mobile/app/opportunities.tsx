  ...
  return (
    <View style={{ flex: 1, backgroundColor: bg(prefs), padding: 16 }}>
      <View style={{ backgroundColor: surface(prefs), borderRadius: 18, padding: 16 }}>
        <Text style={{ color: text(prefs), fontSize: font(24, prefs), fontWeight: "800" }}>Opportunities</Text>
        <Text style={{ color: muted(prefs), marginTop: 8, fontSize: font(16, prefs) }}>Internships, training, and on-the-job opportunities matched by readiness.</Text>
      </View>
    </View>
  );
}
