...
export default function SponsorshipsPortal() {
  ...
  async function apply() {
    ...
    try {
      ...
      setMsg("✅ Application submitted. You will be matched fairly when sponsorships are available.");
  ...
  return (
    <div className="grid">
      <div className="card col-12">
        <div className="h1">Compassionate Give — Learner Support</div>
        ...
        {!profile && <div className="muted">Loading…</div>}
        {profile && (
          <>
