...
export default function Page() {
  return (
    <main style={{maxWidth: 980, margin: "0 auto", padding: 24}}>
      <h1 style={{fontSize: 28, fontWeight: 700, marginBottom: 8}}>About Readytolearn</h1>
      <p style={{opacity: 0.85, marginBottom: 16}}>Inclusive learning for beginners through professional levels, with career pathways.</p>
