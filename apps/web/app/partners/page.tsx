...
export default function Page() {
  return (
    <main style={{maxWidth: 980, margin: "0 auto", padding: 24}}>
      <h1 style={{fontSize: 28, fontWeight: 700, marginBottom: 8}}>Partners</h1>
      <p style={{opacity: 0.85, marginBottom: 16}}>Partnerships with educators, nonprofits, and training providers.</p>
